  ...
  for (int i = 0; i < N; i++)
    {
     ...
     values_1[i] = map_double(adc_out_1[i], 1434, 2712, -311.15, 311.15);
     values_2[i] = map_double(adc_out_2[i], 1437, 2697, -311.15, 311.15);
     values_3[i] = map_double(adc_out_3[i], 1428, 2714, -311.15, 311.15);
