...
void loop() {
  ...
  if (Serial3.available()) {
    ...
    if (status == RECEIVING1 && c >= '0' && c <= '9') {
      ...
      Display_Phasors_on_Native_SerialUSB_Terminal();
...
void Display_Phasors_on_Native_SerialUSB_Terminal(){
  SerialUSB.print("Phasor Magnitude for Phase 1 is: ");
  SerialUSB.println(float(Phasor_Magnitude_1/100));
  SerialUSB.print("Phasor Magnitude for Phase 2 is: ");
  SerialUSB.println(float(Phasor_Magnitude_2/100));
  SerialUSB.print("Phasor Magnitude for Phase 3 is: ");
  SerialUSB.println(float(Phasor_Magnitude_3/100));
  
  SerialUSB.print("Phase 1 Angle is: ");
  SerialUSB.println(Phasor_Angle_Degree_1);
  SerialUSB.print("Phase 2 Angle is: ");
  SerialUSB.println(Phasor_Angle_Degree_2);
  SerialUSB.print("Phase 3 Angle is: ");
  SerialUSB.println(Phasor_Angle_Degree_3);

  SerialUSB.print("Latitude ");
  SerialUSB.print(Latitude/1000);
  SerialUSB.print(" ");
  SerialUSB.print("Longitude ");
  SerialUSB.print(Longitude/1000);
