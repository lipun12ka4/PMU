...
void loop() {
  time_before_calculation=millis();
  ...
  for (int i = 0; i < N; i++)
    ...
    time_after_calculation=millis();
    time_elapsed=time_after_calculation-time_before_calculation;
    ...
    Serial.print("Time Elapsed for One Set of Phasor Calculation is:");
